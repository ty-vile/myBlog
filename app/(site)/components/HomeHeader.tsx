...
const HomeHeader = () => {
  return (
    <div className="flex flex-col lg:flex-row gap-8 ">
      ...
      <div className="flex flex-col lg:items-center gap-8 border-4 p-6 border-black w-fit rounded-lg shadow-card hover:-translate-x-1 hover:-translate-y-1 transition-all duration-500">
        <h2 className="text-3xl">Total Blogs</h2>
        <h5 className="text-xl">17</h5>
      </div>
    </div>
  );
};
